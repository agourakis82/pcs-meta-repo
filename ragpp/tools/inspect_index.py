...
client = chromadb.PersistentClient(
    path="ragpp/index/lit2025",
    settings=Settings(allow_reset=False, anonymized_telemetry=False),
)
col = client.get_collection("lit2025")

print("Index inspection for collection 'lit2025':")
...
if col.count() > 0:
    ...
    if peek["documents"]:
        print(
            f"- Sample documents (first 200 chars): "
            f"{[doc[:200] + '...' for doc in peek['documents']]}"
        )
