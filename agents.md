# Agents Man# Agents Manifest - PCS-Meta-Repo
...
- **steps**:
  ...
  - `markdownlint-cli2 --config .markdownlint-cli2.jsonc "**/*.md" "#.git" "#node_modules"`
...
*Modo Agentico v1.0 - PCS-Meta-Repo*fest - PCS-Meta-Repo
